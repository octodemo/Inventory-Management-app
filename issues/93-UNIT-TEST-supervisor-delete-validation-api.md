...
## Acceptance Criteria
- [ ] Unit test verifies DELETE /api/supervisors/:id deletes supervisor and returns 204 No Content when no premises assigned
- [ ] Unit test verifies DELETE /api/supervisors/:id returns 409 Conflict when supervisor has assigned premises

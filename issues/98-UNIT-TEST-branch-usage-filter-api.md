...
## Acceptance Criteria
- [ ] Unit test verifies POST /api/reports/branch-wise with branchIds filter returns only data for specified branches
- [ ] Unit test verifies usage data is aggregated correctly per branch with branch details
